...
|---|---|---|---|---|---|
| 2026-08-15 | results/MODEL_SELECTION.md | model_selection.py | df4864f | ADR-020 (pending) | RandomForest_n100_depth10/diff selected on validation (MAE 4.087); rolling protocol beats baseline overall (4.87 vs 5.22 MAE) but static does not (6.69 vs 5.22 MAE). |
